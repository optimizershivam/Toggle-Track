...
import homestyle from "./secondHome.module.css";
import {  ChevronRightIcon } from "@chakra-ui/icons";

const SecondHome = () => {
  return (
    <div className={homestyle.fixtop}>
      ...
      <div className={homestyle.small_div_homepage}>
        <div className={homestyle.small_div1_hp}>
          <p className={homestyle.sp1_h_para}>PROJECT BUDGETING</p>
        ...
        <div className={homestyle.small_div2_hp}>
          <p className={homestyle.sp1_h_para}>REPORTING</p>
          <h1 className={homestyle.head_text_small_div}>
          Quickly spot trends and get a big picture view in one intuitive dashboard. Share key insights for transparency.
          </h1>
          <div className={homestyle.small_div_learnmore}>
            <p>
              Learn more <ChevronRightIcon />
        ...
        <div className={homestyle.small_div3_hp}>
          <p className={homestyle.sp1_h_para}>PAYROLL</p>
          <h1 className={homestyle.head_text_small_div}>
          Pay employees accurately and on time. Calculating salaries has never been so easy.
          </h1>
          <div className={homestyle.small_div_learnmore}>
            <p>
              Learn more <ChevronRightIcon />
      ...
      <div className={homestyle.imgpercentup}>
        <img style={{width:"100%"}}
      ...
      <div>
          <span style={{ color: "rgb(229, 124, 216)", fontWeight: "bold", fontSize:"50px",marginLeft:"20%" }}>
        ...
        <div>
          <span style={{ fontWeight: "bold", fontSize:"50px",marginLeft:"30%"}}>
           100
          </span>
